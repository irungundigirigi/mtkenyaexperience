    ...
    <div className={styles.heroContainer}>
      ...
      <div className={styles.textContainer}>
        <div className={styles.heroText}>
          ...
          <div className={styles.subtitle}>Sharing your Mt. Kenya hiking experiences isn't just about reliving the adrenaline rush or boasting about your conquests; it's about paying it forward and helping others embark on their own mountain journey. By sharing your tales of triumphs and trials, you offer invaluable insights that can guide aspiring trekkers in their preparations. Your firsthand accounts shed light on the gear essentials, trail conditions, and unexpected challenges that await on the mountain's slopes.<div className={styles.p}> Moreover, sharing preserves your memories in a vibrant tapestry of experiences, ensuring that each summit, each sunrise, and each encounter with nature is immortalized and cherished. Your stories become beacons of inspiration, encouraging others to chase their dreams, conquer their fears, and embrace the unparalleled beauty of the mountain wilderness. So, let's embark on this journey together, armed with knowledge, fueled by passion, and united by the shared love for adventure and exploration.</div></div>
        </div>
      </div>
    </div>
  );
